...
#include "Protocol/EthernetIP/AddressTable.h"
...
void setup()
{
    ...
    ethernetIP::AddressTable testTable;

    testTable.Update("Type_SINT");
    testTable.Update("Type_REAL");
    testTable.Update("Type_INT");
    testTable.Update("Type_LINT");
    testTable.Update("Type_DINT");

    
    testTable.Update("Type_REAL_A1D[3]");
    testTable.Update("Type_REAL_A2D[0][2]");
    testTable.Update("Type_REAL_A3D[1][2][3]");

    testTable.Update("Type_INT_A1D[3]");
    testTable.Update("Type_INT_A2D[0][2]");
    testTable.Update("Type_INT_A3D[1][2][3]");

    testTable.Update("Type_SINT_A1D[3]");
    testTable.Update("Type_SINT_A2D[0][2]");
    testTable.Update("Type_SINT_A3D[1][2][3]");

    testTable.Update("Type_LINT_A1D[3]");
    testTable.Update("Type_LINT_A2D[0][2]");
    testTable.Update("Type_LINT_A3D[1][2][3]");

    testTable.Update("2_Type_SINT");
    testTable.Update("2_Type_REAL");
    testTable.Update("2_Type_INT");
    testTable.Update("2_Type_LINT");
    testTable.Update("2_Type_DINT");

    
    testTable.Update("2_Type_REAL_A1D[3]");
    testTable.Update("2_Type_REAL_A2D[0][2]");
    testTable.Update("2_Type_REAL_A3D[1][2][3]");
    testTable.Update("2_Type_INT_A1D[3]");
    testTable.Update("2_Type_INT_A2D[0][2]");
    testTable.Update("2_Type_INT_A3D[1][2][3]");
    testTable.Update("2_Type_SINT_A1D[3]");
    testTable.Update("2_Type_SINT_A2D[0][2]");
    testTable.Update("2_Type_SINT_A3D[1][2][3]");
    testTable.Update("2_Type_LINT_A1D[3]");
    testTable.Update("2_Type_LINT_A2D[0][2]");
    testTable.Update("2_Type_LINT_A3D[1][2][3]");

    testTable.Update("3_Type_REAL_A1D[3]");
    testTable.Update("3_Type_REAL_A2D[0][2]");
    testTable.Update("3_Type_REAL_A3D[1][2][3]");
    testTable.Update("3_Type_INT_A1D[3]");
    testTable.Update("3_Type_INT_A2D[0][2]");
    testTable.Update("3_Type_INT_A3D[1][2][3]");
    testTable.Update("3_Type_SINT_A1D[3]");
    testTable.Update("3_Type_SINT_A2D[0][2]");
    testTable.Update("3_Type_SINT_A3D[1][2][3]");
    testTable.Update("3_Type_LINT_A1D[3]");
    testTable.Update("3_Type_LINT_A2D[0][2]");
    testTable.Update("3_Type_LINT_A3D[1][2][3]");
    
    testTable.DebugPrint();


    LOG_INFO(logger,"Batch Count : %d",testTable.GetBatchCount());
    LOG_INFO(logger,"======== Batch 0 Tags ========");
    std::vector<std::string> batch0 = testTable.RetrieveTagsByBatch(0);
    for (const auto& tag : batch0) 
    {
        Serial.printf("%s\r\n",tag.c_str());
    }

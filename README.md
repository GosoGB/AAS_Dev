...
### 신규 기능
  - [CLI] MQTT 브로커, NTP 서버, MFM API 정보 등 변경 기능 추가
  - [MT11] 서비스 인터페이스 Ethernet 추가
### 기능 개선
  - [W5500] MQTT 브로커와 연결이 지속적으로 끊어지는 버그 수정
# <br><br><br>
# 릴리즈 노트 June 16, 2025
## MUFFIN 프레임워크 Ver.1.4.0 개발 완료
### 신규 기능
  - [MELSEC] 프로토콜 추가
  - [MT11] 디바이스 추가 - 서비스 네트워크는 LTE만 지원하고 있으며 1.4.1 버전에서 모두 지원할 예정
### 기능 개선
  - [Batch Payload] 서버로 전송하는 데이터를 배치형태로 묶어서 전송하는 기능 추가
  - [TOPIC 변경] 기존에 분리되어 있던 INPUT/OUTPUT 토픽을 하나의 토픽으로 통합
  - [원격제어 기능 개선] 장비로 전송하는 값과 디바이스내 설정값을 변경하는 값에 대한 키를 변경함
# <br><br><br>
# 릴리즈 노트 Mar 4, 2025

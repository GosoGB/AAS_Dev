...
namespace muffin { namespace ethernetIP {
    ...
    Status PolledArrayDataTable::UpdateArrayRange(const std::string& tagName, size_t startIndex, const psram::vector<cip_data_t>& values)
    {
    ...
    Status PolledArrayDataTable::GetArrayRange(const std::string& tagName, size_t startIndex, size_t count, psram::vector<cip_data_t>& outValues) const
    {
        outValues.clear();

...
namespace muffin { namespace jarvis {
    ...
    private:
        ...
        // std::pair<rsc_e, std::string> validateOperation(const cfg_key_e key, const JsonArray json, cin_vector* outputVector);
        // std::pair<rsc_e, std::string> validateNode(const cfg_key_e key, const JsonArray json, cin_vector* outputVector);
        // std::pair<rsc_e, std::string> validateAlarm(const cfg_key_e key, const JsonArray json, cin_vector* outputVector);
        // std::pair<rsc_e, std::string> validateOperationTime(const cfg_key_e key, const JsonArray json, cin_vector* outputVector);
        // std::pair<rsc_e, std::string> validateProductionInfo(const cfg_key_e key, const JsonArray json, cin_vector* outputVector);
    private:

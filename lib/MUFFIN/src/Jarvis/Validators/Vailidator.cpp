    ...
    ValidationResult Validator::Inspect(const JsonDocument& jsonDocument, std::map<cfg_key_e, cin_vector>* mapCIN)
    {
        ...
        for (auto config : container)
        {
            ...
            switch (key)
            {
                ...
                //     ret = validateOperation(key, cinArray, &outputVector);
                //     break;
                // case cfg_key_e::NODE:
                //     ret = validateNode(key, cinArray, &outputVector);
                //     break;
                // case cfg_key_e::ALARM:
                //     ret = validateAlarm(key, cinArray, &outputVector);
                //     break;
                // case cfg_key_e::OPERATION_TIME:
                //     ret = validateOperationTime(key, cinArray, &outputVector);
                //     break;
                // case cfg_key_e::PRODUCTION_INFO:
                //     ret = validateProductionInfo(key, cinArray, &outputVector);
                //     break;
                default:
